...
* Fixed critical error when updating products.
* Performed plugin compatibility tests with WordPress 6.5.4.

= 1.5.6 =
* Fixed issues with coupon creation.

= 1.5.5 =
* Updated the plugin to be HPOS compatible and will now allow users to enable HPOS in the admin panel.
* Maintenance work on plugin installation interface.
